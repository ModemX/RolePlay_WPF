...
namespace Ролевая_игра__WPF_
{
    public class Персонаж
    {
        ...
        public uint Максимальное_здоровье_Начальное { get; protected set; }
        ...
        public Персонаж(uint ID, string Имя, bool Пол, uint Возраст, string Раса, double[] МножительСилыРун)
        {
            this.ID = ID;
            this.Имя = Имя;
            this.Пол = Пол;
        ...
        public Персонаж(uint ID, string Имя, bool Пол, uint Возраст, string Раса, bool Ослаблен, bool Болен, bool Отравлен, bool Парализован, bool Мертв, bool Может_говорить, bool Может_двигаться, uint Максимальное_здоровье, uint Очки_Здоровья, uint Очки_Опыта, double[] МножительСилыРун)
        {
            this.ID = ID;
            this.Имя = Имя;
            this.Пол = Пол;
        ...
        protected virtual void Установить_константы()
        {
            if (Раса == "человек")
            {
                Максимальное_здоровье = (uint)(100 * МножительСилыРун[0]);
                Максимальное_здоровье_Начальное = 100;
                Очки_Здоровья = Максимальное_здоровье;
            }
            if (Раса == "гном")
            {
                Максимальное_здоровье = (uint)(150 * МножительСилыРун[0]);
                Максимальное_здоровье_Начальное = 150;
                Очки_Здоровья = Максимальное_здоровье;
            }
            if (Раса == "эльф" || Раса == "эльфийка")
            {
                Максимальное_здоровье = (uint)(130 * МножительСилыРун[0]);
                Максимальное_здоровье_Начальное = 130;
                Очки_Здоровья = Максимальное_здоровье;
            }
            if (Раса == "орк")
            {
                Максимальное_здоровье = (uint)(200 * МножительСилыРун[0]);
                Максимальное_здоровье_Начальное = 200;
                Очки_Здоровья = Максимальное_здоровье;
            }
            if (Раса == "гоблин")
            {
                Максимальное_здоровье = (uint)(120 * МножительСилыРун[0]);
                Максимальное_здоровье_Начальное = 120;
                Очки_Здоровья = Максимальное_здоровье;
            }
        }
        ...
        public static string Лет_Лета_Год(uint Возраст)
        {
        ...
        public void ИзменениеСостоянияЗдоровья(string действие, uint сила_воздействия)
        {
            ...
            else if (действие == "лечение")
            {
                if (сила_воздействия + Очки_Здоровья > Максимальное_здоровье)
                {
                    Очки_Здоровья = Максимальное_здоровье;
                }
                else
        ...
        public void RuneUpdate(double[] НаследованныеМножителиСилыРун)
        {
            МножительСилыРун = НаследованныеМножителиСилыРун;
        }
    }
    ...
    public class Персонаж_с_магией : Персонаж
    {
        ...
        public Персонаж_с_магией(uint ID, string Имя, bool Пол, uint Возраст, string Раса, double[] МножительСилыРун) : base(ID, Имя, Пол, Возраст, Раса, МножительСилыРун)
        {
            this.ID = ID;
            this.Имя = Имя;
            this.Пол = Пол;
